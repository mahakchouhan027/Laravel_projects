...
<body>
    ...
    <div class="header">
        ...
        <table class="contact-info">
          <tr>
            <td class="icon">
                <img src="<?php echo e(public_path('icons/phone-solid-full.png')); ?>" width="12">
            </td>
            <td>+33 7 66 64 29 29</td>

            <td class="icon">
                <img src="<?php echo e(public_path('icons/envelope-regular-full.png')); ?>" width="12">
            </td>
        ...
        <tr>
            <td class="icon">
                <img src="<?php echo e(public_path('icons/house-solid-full.png')); ?>" width="12">
            </td>
        ...
        <tr>
            <td class="icon">
                <img src="<?php echo e(public_path('icons/calandar-regular-full.png')); ?>" width="12">
            </td>
            <td>22 ans (21 août 1997)</td>

            <td class="icon">
                <img src="<?php echo e(public_path('icons/earth-americas-regular-full.png')); ?>" width="12">
            </td>
...
<?php /**PATH C:\Users\mahak\Downloads\Laravel_Work-main\Laravel_Work-main\pdf\resources\views/resume/resume.blade.php ENDPATH**/ ?>